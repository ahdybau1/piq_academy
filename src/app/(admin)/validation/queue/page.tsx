...
export default async function ValidationQueuePage() {
  ...
  const items = await listValidationQueue(undefined, selectedCountryId ?? undefined);

  return <ValidationQueuePageView initialItems={items} countryId={selectedCountryId} />;
}
